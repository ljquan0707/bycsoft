...
_314._outerWidth(opts.showHeader?opts.headerWidth:1366);
...
_315._size("height",isNaN(opts.height)?"":(opts.height-_314.outerHeight()));
_315._size("width",isNaN(opts.width)?"":1336);
}
};
function _318(_319){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_437,blur:_43b,mouseenter:_43f,mouseleave:_442,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
